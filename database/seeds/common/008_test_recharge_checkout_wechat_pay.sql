...
VALUES
    ('bootstrap-payment-method-recharge-wechat-pay', '100001', '0', 'wechat_pay', 'WeChat Pay Recharge', 'sandbox', 'active', 305, 'organization', 'CNY', 'CN', '{"bootstrap":true,"checkoutAliasFor":"wechat_native","environment":"test"}', 'bootstrap-payment-method-recharge-wechat-pay', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
...
VALUES
    ('bootstrap-payment-channel-recharge-wechat-pay', '100001', '0', 'recharge-wechat-pay', 'WeChat Pay Recharge', 'bootstrap-payment-provider-sandbox', 'bootstrap-payment-method-recharge-wechat-pay', 'sandbox', 'api', 'CNY', 'CN', 'active', 305, 305, '{"bootstrap":true,"checkoutAliasFor":"wechat_native","environment":"test"}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT DO NOTHING;
