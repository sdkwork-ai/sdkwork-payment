-- Development keeps the public points-recharge key usable without committing
-- real PSP credentials. The active local sandbox account owns this checkout
-- alias; production profiles wire the same stable key to WeChat Native.
