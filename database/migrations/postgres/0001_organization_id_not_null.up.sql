...
ALTER TABLE commerce_payment_method ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_intent ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_attempt ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_refund ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_refund_event ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_channel ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_provider_account ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_provider_credential ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_sub_merchant ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_certificate ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_route_rule ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_webhook_event ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_webhook_delivery ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_reconciliation_run ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
...
ALTER TABLE commerce_payment_provider ADD COLUMN IF NOT EXISTS organization_id TEXT NOT NULL DEFAULT '0';
