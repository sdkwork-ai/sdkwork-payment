...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `payment-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `payment-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `payment-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `payment.sdkwork.com` | 443 ssl + 80 |
