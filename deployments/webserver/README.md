...
Module `sdkwork-payment` · runtime code `payment` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `payment-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `payment-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `payment-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `payment-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `payment.sdkwork.com` | 443 ssl + 80 |
