# Runbook — sdkwork-payment deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-payment-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-payment/bundle`, loads the image, starts
