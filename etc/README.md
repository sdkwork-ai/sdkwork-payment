# sdkwork-payment Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-payment` |
| `runtimeCode` | `payment` |
| Config root | `/etc/sdkwork/payment/` |
| Runtime TOML | `/etc/sdkwork/payment/config.toml` |
| Secrets | `/etc/sdkwork/payment/secrets/` |
| Override | `SDKWORK_PAYMENT_CONFIG_FILE` |
